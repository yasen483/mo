<?php
$API_KEY = '1883886008:AAGNP3GoeW8dQr2Qua6CRMvjj32twbsFkQI'; // توكن
...
bot('sendMessage',[
       ...
       'reply_markup'=>json_encode([
                ...
                [['text'=>"• بوت زخرفةه ، ⚖ ؛",'callback_data'=>'mak'],['text'=>"• بوت الالعاب ، 🎮 ؛",'callback_data'=>'mak2']],
                    ...
                    [['text'=>"بوت المتجر ،  💖",'callback_data'=>'mak30']], 
                        ]
            ])
        ]);
    }
...
if ($data == 'mak30') {
	$getMe = bot('getMe')->result;
    $file = str_replace("TO", file_get_contents("make.txt"), file_get_contents("bot30.php"));
    file_put_contents("bots/".file_get_contents("make.txt").'/bot30.php', $file);
    bot('sendmessage',[
        'chat_id'=>$chat_id2,
        'text'=>"• تم صنع البوت بنجاح ؛ @$getMe->username ، 🔱
• بواسطة ؛ @$username ،"
